...
parser.add_argument(
    "--include", default=None, type=str, help="Specify the file to be downloaded",
)
parser.add_argument(
    "--exclude", default=None, type=str, help="Files you don't want to download",
)
parser.add_argument(
    "--dataset",
    "-D",
...
if args.model is not None:
    ...
    if args.save_dir is not None:
        if len(model_name) > 1:
            ...
            save_path = os.path.join(args.save_dir, "models--%s" % (model_name[0]))
    ...
    if args.save_dir is not None:
        if len(dataset_name) > 1:
            ...
            save_path = os.path.join(args.save_dir, "datasets--%s" % (dataset_name[0]))
        save_dir_option = "--local-dir %s" % save_path
